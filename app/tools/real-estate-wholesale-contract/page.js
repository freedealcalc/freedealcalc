...
export default function Page() {
  ...
  const schemaFAQ = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
    {"@type":"Question","name":"What is a wholesale real estate contract?","acceptedAnswer":{"@type":"Answer","text":"A wholesale contract is a standard purchase agreement between you and the seller with an assignment clause allowing you to transfer your rights to an end buyer. Key provisions: inspection/due diligence period, earnest money amount, assignment clause language, and closing date."}},
    {"@type":"Question","name":"What should be in a wholesale real estate contract?","acceptedAnswer":{"@type":"Answer","text":"Purchase price, earnest money amount (typically $100-$1,000 for wholesale), inspection/due diligence period (7-14 days), assignment clause (right to assign to another buyer), closing date (30-45 days typically), and as-is condition acknowledgment. Always have an attorney review your contract."}},
    {"@type":"Question","name":"How much earnest money do wholesalers put down?","acceptedAnswer":{"@type":"Answer","text":"Wholesale earnest money is typically $100-$1,000 — enough to show good faith but small enough to limit risk if the deal falls apart. Some sellers require more, especially bank-owned properties. Never put up earnest money you can't afford to lose if due diligence reveals problems."}},
    {"@type":"Question","name":"What is the inspection period in a wholesale contract?","acceptedAnswer":{"@type":"Answer","text":"The inspection/due diligence period (typically 7-14 days) is your window to evaluate the property, get contractor estimates, verify title, and find your end buyer. Most wholesale contracts allow you to exit during this period. Don't let it expire without either assigning the contract or having a firm plan."}},
    {"@type":"Question","name":"Can I wholesale a property without a contract?","acceptedAnswer":{"@type":"Answer","text":"No — you need a signed purchase agreement to have an equitable interest to assign. Verbal agreements have no legal standing. Never market a deal to buyers until you have a signed contract with the seller. The contract is your asset in wholesale real estate."}},
    {"@type":"Question","name":"What happens if I can't find a buyer for my wholesale deal?","acceptedAnswer":{"@type":"Answer","text":"If you can't assign before closing, your options are: extend the closing date (if seller agrees), double close using transactional funding (if you have the spread), purchase and hold/flip yourself (if numbers support it), or exit during the inspection period and lose only your earnest money. Always have an exit strategy before signing."}}
  ]};
  return (
    <>
      ...
      <div style={{minHeight:'100vh',background:'#F0F2F5',fontFamily:'DM Sans, sans-serif'}}>
        ...
        <div style={{background:'#0f1c2d',padding:'72px 24px 80px',textAlign:'center'}}>
          ...
          <h1 style={{fontSize:'clamp(28px, 5vw, 48px)',fontStyle:'italic',color:'#00C27C',fontFamily:'Instrument Serif, serif',lineHeight:'1.15',margin:'0 0 20px',maxWidth:'800px',marginLeft:'auto',marginRight:'auto'}}>Real Estate Wholesale Contract — Free Deal Analyzer</h1>
          <p style={{fontSize:'18px',color:'#94a3b8',maxWidth:'600px',margin:'0 auto 36px',lineHeight:'1.6'}}>Understand wholesale contracts and analyze every deal before you sign. Freddie helps you evaluate wholesale opportunities and know your numbers cold.</p>
        ...
        <div style={{maxWidth:'1100px',margin:'0 auto',padding:'64px 24px 0'}}>
          ...
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>Contract Terms Explainer</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Freddie explains key wholesale contract provisions — inspection periods, assignment clauses, earnest money.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>MAO from Contract Price</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Verify your contract price supports your assignment fee and buyer's profit.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>Assignment Fee Calculator</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Know your net assignment fee after all costs before you sign.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            ...
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Ensure your end buyer has enough margin — deals die when buyers can't make money.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>Double Close vs Assignment</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Freddie helps you choose the right closing structure for your deal.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            ...
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Full deal score on any wholesale structure with shareable certificate.</div>
          </div>
          </div>
        </div>
        <div style={{maxWidth:'1100px',margin:'0 auto',padding:'64px 24px 0'}}>
        ...
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What is a wholesale real estate contract?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>A wholesale contract is a standard purchase agreement between you and the seller with an assignment clause allowing you to transfer your rights to an end buyer. Key provisions: inspection/due diligence period, earnest money amount, assignment clause language, and closing date.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What should be in a wholesale real estate contract?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>Purchase price, earnest money amount (typically $100-$1,000 for wholesale), inspection/due diligence period (7-14 days), assignment clause (right to assign to another buyer), closing date (30-45 days typically), and as-is condition acknowledgment. Always have an attorney review your contract.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>How much earnest money do wholesalers put down?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>Wholesale earnest money is typically $100-$1,000 — enough to show good faith but small enough to limit risk if the deal falls apart. Some sellers require more, especially bank-owned properties. Never put up earnest money you can't afford to lose if due diligence reveals problems.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What is the inspection period in a wholesale contract?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>The inspection/due diligence period (typically 7-14 days) is your window to evaluate the property, get contractor estimates, verify title, and find your end buyer. Most wholesale contracts allow you to exit during this period. Don't let it expire without either assigning the contract or having a firm plan.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>Can I wholesale a property without a contract?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>No — you need a signed purchase agreement to have an equitable interest to assign. Verbal agreements have no legal standing. Never market a deal to buyers until you have a signed contract with the seller. The contract is your asset in wholesale real estate.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What happens if I can't find a buyer for my wholesale deal?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>If you can't assign before closing, your options are: extend the closing date (if seller agrees), double close using transactional funding (if you have the spread), purchase and hold/flip yourself (if numbers support it), or exit during the inspection period and lose only your earnest money. Always have an exit strategy before signing.</p>
        </details>
        </div>
