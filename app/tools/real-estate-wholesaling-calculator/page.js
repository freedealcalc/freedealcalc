...
export default function Page() {
  ...
  const handleFreddie = () => {
    setClicked(true);
    sessionStorage.setItem('fdc_seed_message', 'I want to analyze a wholesale deal. Can you help me calculate my maximum allowable offer and assignment fee?');
    router.push('/freddie');
  };
  ...
  const schemaWebApp = {
    ...
    "@type": "WebApplication",
    "name": "Real Estate Wholesaling Calculator",
    "description": "Free AI-powered real estate wholesaling calculator. Calculate MAO, assignment fees, and wholesale profit instantly.",
    "url": "https://freedealcalc.com/tools/real-estate-wholesaling-calculator",
  ...
  const schemaFAQ = {
    ...
    {
      "@type": "Question",
      "name": "What is a wholesaling calculator?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A wholesaling calculator helps you determine your maximum allowable offer (MAO) — the highest price you can pay for a property and still leave enough room for rehab costs, your assignment fee, and your buyer's profit. Our free AI-powered calculator does this instantly."
      }
    },
    {
      "@type": "Question",
      "name": "How do I calculate MAO for wholesale?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The standard formula is ARV × 70% minus rehab costs minus your assignment fee equals your MAO. For example, a $300K ARV property with $40K rehab and a $15K assignment fee gives you an MAO of $155K. Freddie calculates this automatically."
      }
    },
    {
      "@type": "Question",
      "name": "What is a good assignment fee in wholesaling?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most wholesalers target $5,000 to $20,000 per deal depending on the market and deal size. Luxury markets can support $25K-$50K+ assignments. The key is leaving enough equity for your buyer to profit after their rehab and holding costs."
      }
    },
    {
      "@type": "Question",
      "name": "How is wholesale different from fix and flip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In wholesaling you never actually buy the property — you secure it under contract then assign that contract to an end buyer for a fee. In fix and flip you purchase, renovate, and resell. Wholesale is lower risk, lower capital, faster cycle time."
      }
    },
    {
      "@type": "Question",
      "name": "Can I wholesale without a real estate license?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In most states yes, but regulations vary. You are selling your equitable interest in a contract, not the property itself. Consult a real estate attorney in your state before wholesaling at scale. Freddie can help you analyze deals but is not legal advice."
      }
    },
    {
      "@type": "Question",
      "name": "What markets are best for wholesaling?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "High distress, high investor activity markets work best — think Cleveland, Detroit, Memphis, Atlanta, Baltimore, Kansas City. Markets with motivated sellers, strong cash buyer pools, and enough ARV spread to support assignment fees."
      }
    }
    ]
  };
      ...
      <div style={{ minHeight: '100vh', background: '#F0F2F5', fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <div style={{ background: '#0f1c2d', padding: '72px 24px 80px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: 'clamp(28px, 5vw, 48px)', fontStyle: 'italic', color: '#00C27C', fontFamily: 'Instrument Serif, serif', lineHeight: '1.15', margin: '0 0 20px', maxWidth: '800px', marginLeft: 'auto', marginRight: 'auto' }}>
            Free Real Estate Wholesaling Calculator
          </h1>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '64px 24px 0' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '15px', color: '#4a5568', lineHeight: '1.6', fontFamily: 'DM Sans, sans-serif' }}>Instantly calculate your Maximum Allowable Offer based on ARV and rehab costs.</div>
          </div>
          <div style={{
            background: '#fff',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '15px', color: '#4a5568', lineHeight: '1.6', fontFamily: 'DM Sans, sans-serif' }}>Know exactly how much spread you need to make the deal worth your time.</div>
          </div>
          <div style={{
            background: '#fff',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#00C27C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '10px', fontFamily: 'DM Sans, sans-serif' }}>Buyer's Profit Check</div>
            <div style={{ fontSize: '15px', color: '#4a5568', lineHeight: '1.6', fontFamily: 'DM Sans, sans-serif' }}>Verify your end buyer has enough meat on the bone to close fast.</div>
          </div>
          <div style={{
            background: '#fff',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#00C27C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '10px', fontFamily: 'DM Sans, sans-serif' }}>Rehab Cost Estimator</div>
            <div style={{ fontSize: '15px', color: '#4a5568', lineHeight: '1.6', fontFamily: 'DM Sans, sans-serif' }}>Factor in realistic repair costs so your MAO protects everyone.</div>
          </div>
          <div style={{
            background: '#fff',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#00C27C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '10px', fontFamily: 'DM Sans, sans-serif' }}>Exit Strategy Comparison</div>
            <div style={{ fontSize: '15px', color: '#4a5568', lineHeight: '1.6', fontFamily: 'DM Sans, sans-serif' }}>See wholesale vs wholetail vs fix-and-flip side by side.</div>
          </div>
          <div style={{
            background: '#fff',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '15px', color: '#4a5568', lineHeight: '1.6', fontFamily: 'DM Sans, sans-serif' }}>Get a deal score and shareable certificate to send to buyers instantly.</div>
          </div>
          </div>
        </div>
        ...
        <details style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '16px' }}>
          ...
          <p style={{ marginTop: '12px', fontSize: '15px', color: '#4a5568', lineHeight: '1.7', fontFamily: 'DM Sans, sans-serif' }}>A wholesaling calculator helps you determine your maximum allowable offer (MAO) — the highest price you can pay for a property and still leave enough room for rehab costs, your assignment fee, and your buyer's profit. Our free AI-powered calculator does this instantly.</p>
        </details>
        <details style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '16px' }}>
          <summary style={{ fontSize: '16px', fontWeight: '600', color: '#0f1c2d', cursor: 'pointer', padding: '8px 0', fontFamily: 'DM Sans, sans-serif', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            How do I calculate MAO for wholesale?
          </summary>
          <p style={{ marginTop: '12px', fontSize: '15px', color: '#4a5568', lineHeight: '1.7', fontFamily: 'DM Sans, sans-serif' }}>The standard formula is ARV × 70% minus rehab costs minus your assignment fee equals your MAO. For example, a $300K ARV property with $40K rehab and a $15K assignment fee gives you an MAO of $155K. Freddie calculates this automatically.</p>
        </details>
        <details style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '16px' }}>
          <summary style={{ fontSize: '16px', fontWeight: '600', color: '#0f1c2d', cursor: 'pointer', padding: '8px 0', fontFamily: 'DM Sans, sans-serif', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            What is a good assignment fee in wholesaling?
          </summary>
          <p style={{ marginTop: '12px', fontSize: '15px', color: '#4a5568', lineHeight: '1.7', fontFamily: 'DM Sans, sans-serif' }}>Most wholesalers target $5,000 to $20,000 per deal depending on the market and deal size. Luxury markets can support $25K-$50K+ assignments. The key is leaving enough equity for your buyer to profit after their rehab and holding costs.</p>
        </details>
        <details style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '16px' }}>
          <summary style={{ fontSize: '16px', fontWeight: '600', color: '#0f1c2d', cursor: 'pointer', padding: '8px 0', fontFamily: 'DM Sans, sans-serif', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            How is wholesale different from fix and flip?
          </summary>
          <p style={{ marginTop: '12px', fontSize: '15px', color: '#4a5568', lineHeight: '1.7', fontFamily: 'DM Sans, sans-serif' }}>In wholesaling you never actually buy the property — you secure it under contract then assign that contract to an end buyer for a fee. In fix and flip you purchase, renovate, and resell. Wholesale is lower risk, lower capital, faster cycle time.</p>
        </details>
        <details style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '16px' }}>
          <summary style={{ fontSize: '16px', fontWeight: '600', color: '#0f1c2d', cursor: 'pointer', padding: '8px 0', fontFamily: 'DM Sans, sans-serif', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            Can I wholesale without a real estate license?
          </summary>
          <p style={{ marginTop: '12px', fontSize: '15px', color: '#4a5568', lineHeight: '1.7', fontFamily: 'DM Sans, sans-serif' }}>In most states yes, but regulations vary. You are selling your equitable interest in a contract, not the property itself. Consult a real estate attorney in your state before wholesaling at scale. Freddie can help you analyze deals but is not legal advice.</p>
        </details>
        <details style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '16px' }}>
          <summary style={{ fontSize: '16px', fontWeight: '600', color: '#0f1c2d', cursor: 'pointer', padding: '8px 0', fontFamily: 'DM Sans, sans-serif', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            What markets are best for wholesaling?
          </summary>
          <p style={{ marginTop: '12px', fontSize: '15px', color: '#4a5568', lineHeight: '1.7', fontFamily: 'DM Sans, sans-serif' }}>High distress, high investor activity markets work best — think Cleveland, Detroit, Memphis, Atlanta, Baltimore, Kansas City. Markets with motivated sellers, strong cash buyer pools, and enough ARV spread to support assignment fees.</p>
        </details>
        </div>
