...
export default function Page() {
  ...
  const schemaFAQ = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
    {"@type":"Question","name":"What is gross rent multiplier (GRM)?","acceptedAnswer":{"@type":"Answer","text":"GRM = Property Price ÷ Annual Gross Rent. It measures how many years of gross rent equal the purchase price. A $300,000 property renting for $2,500/month ($30,000/year) has a GRM of 10. Lower GRM means better value relative to rent — but always follow up with full expense analysis."}},
    {"@type":"Question","name":"What is a good gross rent multiplier?","acceptedAnswer":{"@type":"Answer","text":"GRM benchmarks vary by market. In cash flow markets (Midwest, Southeast) a GRM of 7-10 is typical. In appreciation markets (coastal cities) GRM of 15-20+ is common. Always compare to local market GRMs for similar properties — an absolute number means nothing without local context."}},
    {"@type":"Question","name":"How do you use GRM to evaluate rental properties?","acceptedAnswer":{"@type":"Answer","text":"GRM is a quick screening tool. Properties above your market's typical GRM are relatively expensive; below it are relatively cheap. Use GRM to filter a list of properties quickly, then run full NOI and cash flow analysis on those that pass your GRM threshold."}},
    {"@type":"Question","name":"What is the difference between GRM and cap rate?","acceptedAnswer":{"@type":"Answer","text":"GRM uses gross rent (before expenses); cap rate uses NOI (after expenses). GRM is faster to calculate and useful for quick comparisons but ignores expense differences between properties. Cap rate is more accurate for valuation but requires full expense data. Use GRM to filter, cap rate to decide."}},
    {"@type":"Question","name":"What are the limitations of GRM?","acceptedAnswer":{"@type":"Answer","text":"GRM ignores operating expenses, vacancy, and financing costs. Two identical GRM properties could have very different net returns if one has higher taxes, older systems, or worse management. Never buy based on GRM alone — always run full cash flow analysis on any property that passes the GRM screen."}},
    {"@type":"Question","name":"How does GRM change with market conditions?","acceptedAnswer":{"@type":"Answer","text":"GRM rises as property prices increase faster than rents (common in appreciation markets) and falls as rents rise faster than prices (common in tight rental markets). In high-rate environments, rising borrowing costs reduce what buyers can pay, potentially compressing GRMs in some markets."}}
  ]};
  return (
    <>
      ...
      <div style={{minHeight:'100vh',background:'#F0F2F5',fontFamily:'DM Sans, sans-serif'}}>
        ...
        <div style={{background:'#0f1c2d',padding:'72px 24px 80px',textAlign:'center'}}>
          ...
          <h1 style={{fontSize:'clamp(28px, 5vw, 48px)',fontStyle:'italic',color:'#00C27C',fontFamily:'Instrument Serif, serif',lineHeight:'1.15',margin:'0 0 20px',maxWidth:'800px',marginLeft:'auto',marginRight:'auto'}}>Free Gross Rent Multiplier Calculator</h1>
          <p style={{fontSize:'18px',color:'#94a3b8',maxWidth:'600px',margin:'0 auto 36px',lineHeight:'1.6'}}>GRM is the fastest way to filter rental deals before running full analysis. Freddie calculates GRM and tells you instantly if a property is worth a deeper look.</p>
        ...
        <div style={{maxWidth:'1100px',margin:'0 auto',padding:'64px 24px 0'}}>
          ...
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>GRM Calculator</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Instant gross rent multiplier — property price divided by annual gross rent.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>GRM Comparison Tool</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Compare GRM across multiple properties to identify relative value.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>GRM to Cap Rate Bridge</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Understand how GRM relates to cap rate for deeper analysis.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>Market GRM Benchmarks</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Freddie helps you understand typical GRM ranges for your target market.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            <div style={{fontSize:'13px',fontWeight:'700',color:'#00C27C',textTransform:'uppercase',letterSpacing:'0.08em',marginBottom:'10px',fontFamily:'DM Sans, sans-serif'}}>Quick Deal Filter</div>
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Use GRM as a 30-second filter before investing time in full analysis.</div>
          </div>
          <div style={{background:'#fff',borderRadius:'12px',padding:'28px 24px',border:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}>
            ...
            <div style={{fontSize:'15px',color:'#4a5568',lineHeight:'1.6',fontFamily:'DM Sans, sans-serif'}}>Full deal score for any property that passes your GRM filter.</div>
          </div>
          </div>
        </div>
        <div style={{maxWidth:'1100px',margin:'0 auto',padding:'64px 24px 0'}}>
        ...
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What is gross rent multiplier (GRM)?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>GRM = Property Price ÷ Annual Gross Rent. It measures how many years of gross rent equal the purchase price. A $300,000 property renting for $2,500/month ($30,000/year) has a GRM of 10. Lower GRM means better value relative to rent — but always follow up with full expense analysis.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What is a good gross rent multiplier?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>GRM benchmarks vary by market. In cash flow markets (Midwest, Southeast) a GRM of 7-10 is typical. In appreciation markets (coastal cities) GRM of 15-20+ is common. Always compare to local market GRMs for similar properties — an absolute number means nothing without local context.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>How do you use GRM to evaluate rental properties?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>GRM is a quick screening tool. Properties above your market's typical GRM are relatively expensive; below it are relatively cheap. Use GRM to filter a list of properties quickly, then run full NOI and cash flow analysis on those that pass your GRM threshold.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What is the difference between GRM and cap rate?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>GRM uses gross rent (before expenses); cap rate uses NOI (after expenses). GRM is faster to calculate and useful for quick comparisons but ignores expense differences between properties. Cap rate is more accurate for valuation but requires full expense data. Use GRM to filter, cap rate to decide.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>What are the limitations of GRM?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>GRM ignores operating expenses, vacancy, and financing costs. Two identical GRM properties could have very different net returns if one has higher taxes, older systems, or worse management. Never buy based on GRM alone — always run full cash flow analysis on any property that passes the GRM screen.</p>
        </details>
        <details style={{borderBottom:'1px solid #e2e8f0',paddingBottom:'16px',marginBottom:'16px'}}>
          <summary style={{fontSize:'16px',fontWeight:'600',color:'#0f1c2d',cursor:'pointer',padding:'8px 0',fontFamily:'DM Sans, sans-serif',listStyle:'none'}}>How does GRM change with market conditions?</summary>
          <p style={{marginTop:'12px',fontSize:'15px',color:'#4a5568',lineHeight:'1.7',fontFamily:'DM Sans, sans-serif'}}>GRM rises as property prices increase faster than rents (common in appreciation markets) and falls as rents rise faster than prices (common in tight rental markets). In high-rate environments, rising borrowing costs reduce what buyers can pay, potentially compressing GRMs in some markets.</p>
        </details>
        </div>
