...
export const metadata = { title: 'Real Estate Exit Strategies: How to Choose Before You Buy', description: 'The main real estate exit strategies — flip, wholesale, wholetail, BRRRR, long-term hold — how to choose the right one before you close, and how to pivot', alternates: { canonical: 'https://www.freedealcalc.com/blog/real-estate-exit-strategies' } };
