...
export default async function Page() {
  ...
  return (
    <div style={s.page}>
      ...
      <h2 style={s.h2}>Ohio Wholesale Legal Considerations</h2>
      <p style={s.p}>Ohio is one of the most active wholesale markets in the country. Cleveland, Columbus, and Cincinnati all have large investor buyer pools. Ohio's relatively low acquisition prices make double-digit assignment fees achievable on modest percentage margins.</p>
      <h2 style={s.h2}>Finding Motivated Sellers in Ohio</h2>
      <ul style={s.ul}>
      ...
      <p style={s.p}>Your buyer list is your wholesale business's most valuable asset. Attend Ohio REIA meetings, connect with local hard money lenders (they know who's buying), and build relationships with renovation-focused real estate agents. A buyer list of 50 serious investors who actively buy in your target market is enough to move most deals.</p>
      ...
      <div style={s.cta}><div style={s.ctaTitle}>Calculate Wholesale Deals Free</div><div style={s.ctaText}>Freddie calculates ARV and MAO for any Ohio address — enter the property and know your maximum offer instantly.</div><a href="https://www.freedealcalc.com" style={s.ctaBtn}>Run My Wholesale Numbers</a></div>
      <div style={s.divider}/>
