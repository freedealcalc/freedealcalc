...
export const metadata = { title: 'Real Estate Investing for Beginners: Where to Actually Start', description: 'Real estate investing for beginners — the honest guide. Which strategy to start with, what to learn first, and the mistakes that cost investors most.', alternates: { canonical: 'https://www.freedealcalc.com/blog/real-estate-investing-beginners' } };
