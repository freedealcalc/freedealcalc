...
export const metadata = { title: 'Subject-To Real Estate: Buying Properties | FreeDealCalc', description: 'Subject-to explained — buying a property while leaving the seller\'s existing mortgage in place. How it works, the risks, and when to use it.', alternates: { canonical: 'https://www.freedealcalc.com/blog/subject-to-real-estate' } };
