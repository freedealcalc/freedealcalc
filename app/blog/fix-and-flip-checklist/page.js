...
export const metadata = { title: 'Fix and Flip Checklist: Every Step from Acquisition to Close', description: 'The complete fix-and-flip checklist — acquisition, renovation, listing, and sale. Every step an experienced flipper checks before moving to the next phase.', alternates: { canonical: 'https://www.freedealcalc.com/blog/fix-and-flip-checklist' } };
