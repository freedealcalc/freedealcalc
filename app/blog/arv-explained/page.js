...
export const metadata = {
  title: "ARV Explained: After Repair Value in Real Estate | FreeDealCalc",
  description: "ARV (After Repair Value) is the most important number in real estate investing. Learn what it is, how to calculate it accurately, and why getting it wrong costs investors money.",
