...
export const metadata = { title: 'What is Seller Financing in Real Estate? How It Works | FreeDealCalc', description: 'Seller financing explained — when the seller acts as the bank. Terms, structure, benefits for buyers and sellers, and when to use it.', alternates: { canonical: 'https://www.freedealcalc.com/blog/what-is-seller-financing' } };
