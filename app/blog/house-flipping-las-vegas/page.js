...
export default async function HouseFlipVegas() {
  const market = await getMarketData('las vegas');
  return (
    <div style={s.page}>
      ...
      <h1 style={s.h1}>House Flipping in Las Vegas: 2026 Market Guide for Investors</h1>
      <div style={s.intro}>Las Vegas is one of the most active real estate investment markets in the country. Here's what the current data shows for house flippers, wholesalers, and buy-and-hold investors operating in the Las Vegas metro.</div>
      <TopCTA />
      <div style={s.divider}/><h2 style={s.h2}>Market Context</h2><MarketPulse market={market}/>
      
      <div style={s.divider}/>
      <h2 style={s.h2}>Why Investors Choose Las Vegas</h2>
      <p style={s.p}>The Las Vegas metro has characteristics that attract active real estate investors: a combination of distressed inventory, retail buyer demand, and an established wholesale network. Understanding the specific dynamics of this market is what separates investors who find deals from those who don't.</p>
      ...
      <h2 style={s.h2}>Deal Analysis in Las Vegas</h2>
      <p style={s.p}>The 70% rule applies in Las Vegas just as in every market — but the specific numbers change. At higher price points, 5% of ARV is more dollars, which means holding costs are more consequential. Run the full analysis: (ARV × 0.70) − Rehab = Max Offer. Then model holding costs at 8–10 months minimum.</p>
      <div style={s.cta}>
        <div style={s.ctaTitle}>Analyze Your Las Vegas Deal Free</div>
        <div style={s.ctaText}>FreeDealCalc runs flip, rental, BRRRR, and wholesale analysis for Las Vegas deals — Rentcast ARV comps, full cost model, deal score. Free with Freddie.</div>
        <a href="https://www.freedealcalc.com/freddie" style={s.ctaBtn}>Analyze My Las Vegas Deal →</a>
      </div>
      <h2 style={s.h2}>Finding Deals in Las Vegas</h2>
      <ul style={s.ul}>
        <li style={s.li}><strong>Wholesale networks:</strong> Most major markets have active REIA meetings and wholesale deal flow. Connect with local wholesalers who specialize in the Las Vegas market.</li>
