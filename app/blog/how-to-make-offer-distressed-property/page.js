...
export const metadata = { title: 'How to Make an Offer on a Distressed Property | FreeDealCalc', description: 'How to make offers on distressed properties — how to price them, what terms matter, how to negotiate, and how to protect yourself if condition is worse', alternates: { canonical: 'https://www.freedealcalc.com/blog/how-to-make-offer-distressed-property' } };
