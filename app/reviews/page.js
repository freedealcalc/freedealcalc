...
const SEED_REVIEWS = [
  {
    ...
    strategy: 'Fix & Flip',
    score: 100,
    body: 'Ran a $130K hoarder house deal and got a perfect 100. The scoring broke down exactly why it worked — margin, ROI, rehab ratio. Printed the certificate and used it in my pitch deck.',
  ...
  },
  {
    ...
    strategy: 'Wholesale',
    score: 72,
    body: 'Scored a deal at 72 before sending it to my buyers list. Freddie flagged the rehab estimate as the weak point — ended up renegotiating the purchase price and it closed.',
    created_at: '2026-05-08',
  },
  {
    id: 3,
    username: 'BRRRRbuilder',
    strategy: 'BRRRR',
    score: 61,
    body: 'Used the BRRRR analysis on a duplex in Stafford. Score came back 61, which matched my gut — solid but not a slam dunk. Appreciated having the numbers laid out.',
